...
//    AccountAuthService service = AccountAuthManager.getService(MainActivity.this, authParams);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (Build.VERSION.SDK_INT <= Build.VERSION_CODES.P){
            Log.i(TAG, "sdk <= 28 Q");
            if (ActivityCompat.checkSelfPermission(MainActivity.this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(this,
        ...
        ImageButton toMapBtn = findViewById(R.id.toMapBtn);
        ...
        findViewById(R.id.hwSignIn).setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                silentSignInByHwId();
            }
    ...
    @Override
    public void onClick(View v) {
        if (v.getId() == R.id.hwSignIn){
            silentSignInByHwId();
        } else if (v.getId() == R.id.toMapBtn){
            openMapActivity();
        }
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == REQUEST_CODE_SIGN_IN) {
            Log.i(TAG, "onActivityResult of signInIntent, request code: " + REQUEST_CODE_SIGN_IN);
